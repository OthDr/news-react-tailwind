      ...
      <div className='w-full h-screen flex flex-col items-center justify-center bg-slate-900'>
        ...
        <div className='w-[80%]  mx-auto sm:w-[60%] md:w-[50%] lg:w-[35%]  border-indigo-500/20 rounded-md'>
          ...
          <div className='justify-center p-4'>
            ...
            <h1 className='w-full text-center text-xl font-semibold text-indigo-500/30'>Registration</h1>
          </div>

          <div className='flex w-[90%] mx-auto mt-4'>
            <div className="w-full group mx-auto flex items items-center mr-2 p-2 bg-stone-50/5 rounded-md">
              <GoPerson className='mx-2 cursor-pointer group-hover:scale-110 duration-500 text-stone-50/40 group-hover:text-indigo-400' size={25} />
              <input className=' outline-none w-full text-sm sm:text-base  p-1 text-indigo-400 rounded-md bg-transparent' placeholder='first name' type="text" />
            </div>
            <div className="w-full group mx-auto flex items items-center p-2 bg-stone-50/5 rounded-md">
              <GoPerson className='mx-2 cursor-pointer group-hover:scale-110 duration-500 text-stone-50/40 group-hover:text-indigo-400' size={25} />
              <input className=' outline-none w-full text-sm sm:text-base  p-1 text-indigo-400 rounded-md bg-transparent' placeholder='last name' type="text" />
            </div>
          </div>
          ...
          <div className='w-full my-8 flex justify-center'>
            <p className='text-stone-50/40'>Already registred?<Link to='/signin' className='ml-1 text-indigo-500 font-semibold'>Sign in</Link></p>
          </div>
