    ...
    <>
      ...
      <div className='w-full h-screen flex flex-col items-center justify-center bg-slate-900'>
        ...
        <div className='justify-center p-4'>
            ...
            <h1 className='w-full text-center text-lg md:text-xl font-semibold text-indigo-500/75'>Sign In</h1>
          </div>
          ...
          <div className='w-full my-8 flex justify-center'>
            <p className='text-stone-50/60'>Don't have an account?<Link to='/signup' className='ml-1 text-indigo-500 font-semibold'>Register</Link></p>
          </div>
