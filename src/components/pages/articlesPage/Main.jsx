...
const Main = (props) => {
    ...
    return (
        <>
            <div className='w-full flex flex-col items-center my-2 p-2 bg-indigo-200/10'>
                {allArticles &&
                    allArticles.map((article, i) => (
                        <div key={i} className="w-[90%] md:w-[50%] flex flex-col items-start my-4 border-[1px] border-stone-900/15 p-4">
                            ...
                            <span className='text-xs md:text-sm font-semibold text-amber-500 border-l-4 border-amber-500 p-1 my-2'>{article.createdAt && article.createdAt.split('T')[0]}</span>
